-- Migracja naprawcza V1.2: Dodanie brakujących kolumn do tabeli users
-- Data: 2024-01-15
...
BEGIN
    ...
    -- Zostawiamy password_hash jak jest (nie zmieniamy nazwy)
    ...
    -- Dodaj kolumnę password_hash jeśli nie istnieje (ani password, ani password_hash)
